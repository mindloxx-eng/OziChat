...
const ContactsScreen: React.FC<ContactsScreenProps> = ({ chatList, onSelectChat, onNavigateToProfile, onNavigateToAddContact, onNavigateToCreateGroup, onNavigateToJoinGroup, onNavigateToSettings, onNavigateToMarketplace, onNavigateToAllContacts, onNavigateToAI, navProps }) => {
  ...
  const menuItems = [
    ...
    { label: 'Join Group', icon: ShareIcon, action: onNavigateToJoinGroup },
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-[#0B0E14] text-black dark:text-[#F1F5F9] transition-colors duration-300">
      ...
      <header className={`p-4 pt-6 flex flex-col gap-5 shrink-0 backdrop-blur-xl z-20 transition-all duration-300 shadow-md dark:shadow-none border-b bg-white/95 dark:bg-[#111827]/90 border-gray-100 dark:border-white/5`}>
      ...
      <div className="text-center text-gray-400 dark:text-slate-600 text-[9px] font-black uppercase tracking-[0.4em] py-1 shrink-0 opacity-40 pointer-events-none">
