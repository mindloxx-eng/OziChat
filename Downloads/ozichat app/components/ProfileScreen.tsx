...
const ProfileScreen: React.FC<ProfileScreenProps> = ({ onBack, onNavigateToVerification }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-[#050508] text-white overflow-hidden relative">
      ...
      {/* Header HUD */}
      <header className="flex items-center justify-between p-6 z-20 sticky top-0 bg-gradient-to-b from-[#050508] to-transparent">
